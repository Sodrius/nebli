...
**2. Tamanho — teto 15 páginas (CANON 2026-08-25, pedido de Davi; substitui o teto de 22 de 2026-05-25).** Piso 2, **teto 15 páginas de E1** (da página de abertura da etapa até a anterior ao banner *Resumindo*). Ordem de grandeza que cabe nesse teto: **8–10 subtópicos** de ~400–500 palavras, **9–12 figuras**, ~3.500–5.500 palavras de miolo. Auditável por `auditar_pdf.py` (`check_paginas_e1` + `check_palavras_e1`), como aviso.

**Como o teto se resolve: no planejamento, não na cirurgia.** O teto é orçamento declarado na Seção A do Tema Card *antes* de redigir — não uma poda depois de pronto. Quando o tema não couber, as alavancas, nesta ordem: (a) **estreitar o recorte** e declará-lo ("o slide cobre X; esta E1 cobre X₁, e X₂ fica para outra corrida"); (b) **fundir subtópicos conceitualmente irmãos** ("distrófica" + "metastática" → "as duas calcificações"); (c) **cortar figura de baixo rendimento** pelo filtro da diretriz 15, não encolher todas; (d) **converter catálogo em tabela** pelos gatilhos da Categoria 18 do `EXEMPLARES.md`. O que **não** é alavanca: comprimir leading/spacing, encolher fonte, cortar a conclusão integradora, espremer a prosa até virar tópico disfarçado — isso troca páginas por didática, que é o oposto da missão.

**Se ainda assim não couber**, a leitura correta é que o recorte está largo demais para uma apostila só: estreitar e dizer o que ficou de fora vale mais do que entregar 23 páginas que o aluno não relê. Estourar o teto é decisão do Davi, não default do redator — reportar no fechamento e perguntar, em vez de passar por cima em silêncio.
