...
**5.bis. Do zero — 2ª parte do Resumindo (CANON 2026-08-27).** Junto do `resumindo.typ`, entregar também `resumindo-zero.typ`: um glossário de **15–30 termos** para quem **não leu a E1** e quer chegar na aula sabendo o vocabulário. Público oposto ao do Resumindo comum — aquele é revisão, este é primeiro contato. Cada termo ganha 15–30 palavras em linguagem do dia a dia, dizendo o que é e por que importa. **Ordem lógica de construção, nunca alfabética:** se o termo B depende do A, A vem antes, e a lista tem que poder ser lida de cima para baixo como uma escada. Sem sigla nova, sem `#termo-nota`, sem remissão a outro resumo. Campo `abertura` (3–5 linhas) situa o leigo no assunto antes do primeiro termo. É a única seção do NEBLI onde a definição precede o mecanismo — aqui a função é dar nome ao que o professor vai falar, não ensinar o mecanismo. Heurística de cobertura: todo `#termo-nota` e toda `#sigla` da E1 merecem entrada, mais o que o professor usa em aula sem definir. Assinatura em `typst-template/TEMPLATE_API.md` § `resumindo-zero-page`.
