...
- **Seção A** — Tema · Slug · Disciplina · Onde estudar · **Onde aprofundar (plataformas)** · Alvo de páginas E1 (piso 2, **teto 12** — canônico 2026-09-03, recalibrado 2026-09-07 com a tipografia compacta) · Recorte slide×tema · **Teto histórico** (o que a prova já cobrou deste conteúdo) e **degrau** (onde a E1 vai além, e qual mecanismo) · **Prioridades desta corrida** (do Diário de revisões). O campo `profundidade:` foi aposentado em 2026-09-03 — o padrão é único, "superior à da prova" (ver `CLAUDE.md` § Profundidade elevada, item 1).
...
**Negrito marca o que é mais importante (CANON 2026-09-07, pedido de Davi).** Deixou de ser cota defensiva e virou obrigação positiva: em cada parágrafo de mecanismo, o termo ou a afirmação que o aluno leva embora vai em negrito. Alvo **2–4 por parágrafo**; parágrafo de mecanismo sem nenhum negrito é sinal de que não se decidiu qual é a peça principal. Não negritar: frase inteira, conectivo, número solto sem o que ele significa, ou termo já negritado antes no mesmo subtópico. Exceção conhecida: a seção "Antes da aula" (diretriz 18), onde o negrito marca o termo sendo plantado e 4–5 por parágrafo é normal. Mini-resumo varia fórmula: "Em uma frase:", "Se você só lembrar de uma coisa:", "O que ficou de pé:" — nunca o mesmo dois seguidos.
...
**2. Tamanho (revisto 2026-09-03, teto recalibrado 2026-09-07).** Piso 2, **teto 12 páginas** — era 15 até a tipografia compacta (`CLAUDE.md` § Tipografia compacta); a mesma quantidade de texto passou a caber em menos páginas, e o teto acompanhou para não virar licença de escrever mais. Formato-alvo 3 PARTES × 3 subtópicos: 8–10 subtópicos no total, **450–550 palavras cada**, ~5.000–5.500 palavras de miolo. Quando o tema pede mais de 10 subtópicos, **funda irmãos** em vez de espremer todos — compressão uniforme custa mecanismo. Completude ainda vence o teto, mas só depois de os cinco desperdícios do `ERROS.md` F10 e o filtro das três funções (`CLAUDE.md` § Registro científico) terem sido aplicados; a quebra vai declarada no relatório.

**Isto é gate, não convite (2026-09-03).** `precompile-check.py` bloqueia a compilação fora de 8–10 subtópicos ou acima de 6.000 palavras de miolo; `pos_pipeline_check.py` bloqueia mover o PDF acima de 12 páginas de E1. O gate de palavras é o que limita conteúdo e não muda com a tipografia; o de páginas se recalibra quando a fonte muda. A exceção da § Missão continua existindo, mas passou a exigir `--quebra-declarada "motivo"` — estouro silencioso não é mais possível.
...
**18. "Antes da aula" — `pre-aula.typ` (CANON 2026-08-28).** Toda E1 fechada gera também a seção de abertura do PDF, que vive entre a capa e o sumário. **1–2 páginas de prosa contínua na voz NEBLI contando a história da aula**, 900–1100 palavras (a contagem de palavras é o invariante, não a de páginas — ver `CLAUDE.md` § Tipografia compacta), **sem figura**, encerrando em uma linha do tipo "chegue com esse mapa na cabeça". Não é sumário executivo nem mini-E1: é a narrativa do que a aula vai fazer e em que ordem, para o aluno ler na véspera.
