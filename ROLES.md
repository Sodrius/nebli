...
- **Seção A** — Tema · Slug · Disciplina · Onde estudar · **Onde aprofundar (plataformas)** · Alvo de páginas E1 (piso 2, **teto 15** — canônico 2026-08-25) · Recorte slide×tema · **Prioridades desta corrida** (do Diário de revisões).
...
**2. Tamanho — teto 15 páginas, cumprido por CONCISÃO (CANON 2026-08-25, pedido de Davi; substitui o teto de 22 de 2026-05-25).** Piso 2, **teto 15 páginas de E1** (da abertura da etapa até a anterior ao banner *Resumindo*). Orçamento típico: **10–12 subtópicos de ~350–420 palavras**, **9–12 figuras**, **~4.000–5.000 palavras** de miolo. Auditável por `auditar_pdf.py` (`check_paginas_e1`, `check_palavras_e1`), como aviso.

**O que NÃO muda — invariantes.** Cobertura completa do slide (todo subtópico da aula entra na E1), passe de aprofundamento da diretriz 17 (≈1 injeção mecanística por subtópico, padrão elevado de 2026-07-12), conclusão integradora de 4 camadas, cota de figura por PARTE, termo-notas 6–10. **Cumprir o teto cortando qualquer um deles é proibido** — assim como comprimir leading, encolher fonte ou transformar prosa em tópico. Isso troca páginas por didática.

**A única alavanca é escrever mais direto e mais didático.** O corte é de *palavras por ideia*, não de ideias. A referência empírica: a E1 de acúmulos celulares tinha 12 subtópicos em 8.643 palavras (720 por subtópico) — o mesmo conteúdo cabe em ~4.500 com prosa enxuta. Onde a gordura mora, em ordem de rendimento:

1. **Preâmbulo antes do mecanismo.** Abrir com o mecanismo afirmado, não com a frase que anuncia que ele virá. "Antes de entender por que a gordura sobra, é preciso ver o trajeto que ela faz quando tudo funciona" → cortar e começar o trajeto.
2. **O parágrafo que reafirma o anterior em outro registro.** Explicar bem uma vez vence explicar duas vezes de dois jeitos. Se o segundo parágrafo não acrescenta passo mecanístico novo, ele é resumo disfarçado — corta.
3. **Moldura conversacional em excesso.** As manobras da Categoria 17 do `EXEMPLARES.md` custam página: em regime de 15, a dosagem cai para **no máximo 1 por subtópico**, no ponto que mais carrega — não 2–3. "Vale notar", "guarde isso", "o ponto fino é", "dito de outro modo" só onde mudam a leitura.
4. **Legenda que reexplica o texto.** A legenda acrescenta o que a figura mostra e o parágrafo não disse — 1 a 3 linhas. Legenda de 6 linhas que reconta o mecanismo é um parágrafo duplicado.
5. **`#mini-resumo` em toda esquina.** Ele existe para parágrafo longo de verdade (>5 linhas densas), não como fecho ritual de subtópico. Um por PARTE costuma bastar.
6. **Catálogo em prosa que devia ser tabela.** Pelos gatilhos da Categoria 18: tipos discretos com um traço definidor cada, ou cruzamento de 2+ dimensões. A tabela diz o mesmo em um terço do espaço.
7. **Adjetivo e advérbio de reforço.** "extremamente", "exatamente", "simplesmente", "justamente", "profundamente" — quase sempre saem sem perda.

**Teste de fechamento.** Passe o olho em cada parágrafo e pergunte: *que passo mecanístico novo este parágrafo entrega?* Se a resposta for "nenhum, ele reforça o anterior", ele sai. Se não couber depois disso, a prosa ainda tem gordura — releia antes de reportar. Estourar o teto é decisão do Davi, não default do redator.
