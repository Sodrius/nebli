...
**Apostila de alto nível científico que leva o aluno do básico ao aprofundado.** Premissa: o aluno sabe pouco e tem dificuldade real no tema; o resumo é a ferramenta dele para aprender muito — e o que ele aprende tem que estar tecnicamente correto e dito com o nome certo. Toda decisão editorial — voz, profundidade, jargão, figuras, distratoras — passa por esse filtro. Em conflito entre concisão e ensinar bem, ensinar bem vence; mas **texto que não ensina não é concisão sacrificada, é gordura**, e sai (ver § Registro científico).

## Registro científico — rigor com fluidez (CANON 2026-09-03)

Pedido de Davi, e passa a governar a voz de **todo resumo NEBLI**: *"usar uma linguagem mais técnica e cientificamente adequada, sem perder a fluidez e o tom didático, mas fazê-lo com mais rigor — linguagem ainda extremamente fluida e didática, mas mais sucinta e que dispensa baboseiras, como frases sem nenhum valor. O objetivo é ser uma apostila de alto nível científico."*

**O alvo.** Não é prosa acadêmica seca, e não é monitor com jargão diluído. É o registro de um **bom capítulo de livro-texto de referência** — Robbins, Lehninger, Abbas — que ensina do zero com precisão técnica integral e sem uma frase sobrando. Fluidez continua sendo o motor; o que muda é que a fluidez passa a vir do **encadeamento causal**, não de enchimento conversacional.

**Como o jargão muda (atualiza a diretriz 3 do Redator).** A regra antiga adiava o nome técnico: "ligação temporária entre o açúcar e a enzima (chamada thiohemiacetal)". A nova **não adia e não parafraseia**: o termo correto entra **junto** da definição, na mesma frase — "a glicose forma com a enzima um *thiohemiacetal*, ligação covalente temporária que segura o substrato durante a oxidação". O aluno continua sendo tratado como quem sabe pouco; o que ele recebe é o nome certo com o significado colado, não um apelido que terá de trocar depois. Perífrase que evita o termo é **perda de rigor**, não ganho de didática.

**As quatro exigências de rigor.**
1. **Nomenclatura exata.** Enzima, receptor, via, célula e estrutura pelo nome que a literatura usa — "serina-quinases de estresse", não "umas enzimas que atrapalham".
2. **Quantidade com unidade e ordem de grandeza** sempre que o número for parte do mecanismo, e nunca um número solto sem o que ele significa.
3. **Força da afirmação calibrada.** Distinguir causa estabelecida, associação e modelo em disputa. "Está associado a" não vira "causa" por conveniência de frase.
4. **Antropomorfismo não substitui mecanismo.** "A célula decide" é recurso ocasional de fluidez; se for a única explicação daquele passo, falta mecanismo.

**O filtro anti-baboseira — teste das três funções.** Antes de fechar cada subtópico, toda frase precisa cumprir **pelo menos uma** destas funções: (a) afirma um fato ou um passo de mecanismo novo; (b) faz a ponte causal entre dois fatos já postos; (c) nomeia, define ou delimita um termo. Frase que não cumpre nenhuma **sai**. Alvos típicos: moldura que anuncia o que virá, reafirmação do que acabou de ser dito com outras palavras, adjetivo avaliativo sem conteúdo ("é fundamental compreender", "vale muito a pena notar"), analogia decorativa que não carrega mecanismo, fechamento que reconta.
...
**O que é gate e o que é julgamento (endurecido 2026-09-03).** As três consequências abaixo **bloqueiam o pipeline**, não são convite: `precompile-check.py` (antes de compilar) exige **8–10 subtópicos**, **miolo ≤ 6.000 palavras** e **alternativas de Consolidação com média ≤ 20 palavras**; `pos_pipeline_check.py` (antes de mover o PDF) exige **E1 ≤ 12 páginas** (era 15 até 2026-09-07, quando a tipografia mudou — ver § Tipografia compacta), com escape `--quebra-declarada "motivo"` para a exceção que a § Missão permite. O *registro* em si — jargão na mesma frase, filtro das três funções — **não é gateável**: padrões lexicais de baboseira foram testados contra três resumos reais (incluindo o que Davi marcou como inflado) e não acusaram nada em nenhum. O que os gates travam é o **sintoma** do registro frouxo, que é a inflação; a qualidade da frase continua sendo julgamento declarado no Tema Card e no relatório de fechamento.

**As três consequências que Davi derivou desta mudança:**
- **Teto da E1 cai de 22 para 15 páginas** (e de 15 para **12** em 2026-09-07, com a tipografia nova — a mesma quantidade de texto numa mancha mais densa). Formato-alvo 3 PARTES × 3 subtópicos; 8–10 subtópicos no total, 450–550 palavras cada, ~5.000–5.500 palavras de miolo. Doze ou mais subtópicos só cabem espremendo cada um a ~380 palavras, o que costuma custar mecanismo — nesse caso **funda subtópicos irmãos** em vez de comprimir todos.
- **Profundidade padronizada em "superior à da prova".** Ver § Profundidade elevada, item 1.
- **Consolidação da E2 volta a ser decoreba.** Ver § Rules globais.

## Tipografia compacta (CANON 2026-09-07)

Pedido de Davi: *"que haja bem menos espaço entre linhas, que a fonte diminua (do tamanho da fonte do Lehninger), e que isso seja para todos os resumos. Também que o que for mais importante fique em negrito."*

**O que mudou no template.** Corpo Merriweather de **10pt → 8,5pt**; entrelinha (`leading`) de **1,0em → 0,60em**; espaço entre parágrafos (`spacing`) de **1,2em → 0,90em**. A escolha saiu de uma amostra antes/depois de quatro graus (10 · 9,5 · 9 · 8,5pt) renderizada na mesma página de uma E1 real; Davi escolheu o mais compacto. A mancha resultante é a de um capítulo de livro-texto de referência, coerente com o § Registro científico.

**Todo o fluxo de corpo foi escalado por 0,85 na mesma passada** — caixas (`intro`, `atencao`, `clinica`, `confusao-prevista`, `sintese`, `mini-resumo`, `conclusao`), alternativas da E2, modelo de resposta da E3, legendas de figura, footnotes de `#sigla` e `#termo-nota`, sumário, Resumindo e "Antes da aula". Sem isso, esses elementos passariam a ser **maiores** que o texto corrido e a hierarquia se inverteria. Títulos de PARTE e de subtópico desceram junto (16→14pt, 11→10pt) para a hierarquia não ficar desproporcional.

**As três consequências.**
1. **Teto da E1 cai de 15 para 12 páginas.** Não é aperto de conteúdo: é a mesma quantidade de texto medida numa mancha mais densa — o resumo de inflamação granulomatosa passou de 14 para 10 páginas de E1 sem perder uma palavra. O equivalente aritmético de 15 páginas antigas seria 11; o teto ficou em 12 para dar uma página de folga a resumos com muitas figuras, que ocupam área fixa e não encolhem com a fonte. Implementado em `pos_pipeline_check.py` e `auditar_pdf.py`.
2. **O gate que limita CONTEÚDO continua sendo o de palavras.** Miolo ≤ 6.000 palavras, 8–10 subtópicos, 450–550 palavras cada — tudo isso independe de tipografia e **não mudou**. Se um dia a fonte mudar de novo, é o teto de páginas que se recalibra, nunca o de palavras.
3. **As bandas de largura de figura caem para 34–68%** (ver § Figuras). Figura ocupa área fixa; texto não. Manter as faixas antigas com o corpo novo produz rodapé branco.

**Negrito — o que for mais importante vai em negrito.** A regra antiga era uma cota defensiva ("máx 2–3 por parágrafo"). Agora é uma **obrigação positiva**: em cada parágrafo de mecanismo, o termo ou a afirmação que o aluno leva embora vai em negrito. Alvo **2–4 por parágrafo**; parágrafo de mecanismo sem nenhum negrito é sinal de que o redator não decidiu qual é a peça principal, não de sobriedade. O que **não** vai em negrito: frase inteira (o negrito deixa de marcar), conectivo, número solto sem o que ele significa, e o termo já negritado antes no mesmo subtópico. A seção "Antes da aula" mantém sua exceção — lá o negrito marca *o termo sendo plantado* e 4–5 por parágrafo é normal.
...
- **Ressalva 2026-09-03:** os exemplares foram escritos sob o registro anterior. Onde a superfície da frase deles conflitar com o § Registro científico (jargão adiado, pergunta retórica, frase de moldura), **o registro novo vence**; o *gesto* pedagógico do exemplar continua sendo a referência. Ver a nota no topo do `EXEMPLARES.md`.
...
- **Rigor científico e economia de palavra na E1 (canônico 2026-08-31, elevado a registro científico em 2026-09-03).** Linguagem técnica exata, prosa fluida, zero frase sem função — cortar moldura, legenda que repete o corpo, achado recontado e conclusão que reconta; nunca o mecanismo. Alvo 450–550 palavras por subtópico, 8–10 subtópicos, **teto de 12 páginas** (era 15 até a tipografia de 2026-09-07). Ver § Registro científico, § Tipografia compacta e `ERROS.md` F10.
- **Baseline do aluno (canônico 2026-05-25, atualizado 2026-05-29):** presumir conhecimento BAIXO e dificuldade real com o assunto. O resumo abre cada conceito com **afirmação direta do mecanismo** e **nomeia o termo técnico na mesma frase em que o define** (revisto 2026-09-03 — antes o nome vinha depois; adiar o termo passou a contar como perda de rigor, ver § Registro científico). Aprofundamento vem por camadas — primeiro o "porquê" cru, depois nuance/exceção/integração clínica. Nunca presumir que o aluno "já sabe" um pré-requisito sem retomar em 1–2 frases. **Sem pergunta âncora / pergunta retórica / pergunta ingênua como recurso de abertura** (canônico 2026-05-29 — substitui o antigo "ancora em pergunta ingênua plausível"). Os 5 registros de abertura canônicos são: enquadramento, integração-anterior, integração-posterior, analogia concreta, ponto-de-quebra.
...
- **Consolidação da E2 é decoreba (CANON 2026-09-03, pedido de Davi: "quero as de consolidação bem decorebas").** Reverte a diretriz de 2026-05-28, que mandava subir a densidade cognitiva da Consolidação pelo ângulo "Por que/Como". A divisão de trabalho passa a ser limpa: **Consolidação cobra recall direto** do que precisa estar decorado — nome, número, unidade, sequência, classificação, qual-é-qual, quem-faz-o-quê; **Integração cobra o raciocínio** que cruza dois domínios; **Aplicação cobra a decisão** no cenário clínico. Pergunta de Consolidação que exige raciocínio está na categoria errada e deveria ser Integração. Consequência operacional: as alternativas de Consolidação ficam **curtas (10–20 palavras)** — a banda de paridade 0.80–1.25 continua valendo, medida entre elas, e não há por que inflar distratora até 25–35 palavras nessa categoria. Detalhe em `ROLES.md` § Questionador § Consolidação.
- **Filtro de admissão para Integração na E2 (CANON 2026-05-28):** antes de redigir cada Q11-Q25, gravar em `arquivos-trabalho/integracao-mapa-<slug>.md` uma linha por questão no formato `Qxx conecta [A] + [B]` (dois domínios distintos). Se não preenche o `+`, volta para Consolidação. Gate operacional único — todas as demais alavancas (tipos de cruzamento, padrões de stem, uso do Mapa de Confusões) vivem em `.claude/agents/questionador.md` § "Filtro de admissão" + § "Inspirações e sugestões" como **sugestão**, com liberdade explícita do operador. Sem cotas numéricas — convite > obrigação (ver `feedback_evitar_engessar_anti_engessamento.md`).
...
**DECK-AULA COMPLETO DENTRO DO `/resumo` (CANON 2026-08-03, pedido de Davi).** Toda corrida de `/resumo` passa a **fechar o deck-aula completo e já aplicado no Anki** — reverte a regra antiga de deferir NEBLIcards autorais para uma sessão separada (`PENDENTE-GERADO` deixa de ser estado de ship). O deck é montado de **três fontes, em ordem de prioridade**: (1) **AnKing curado** (espinha dorsal validada), (2) **decks externos de referência** para lacuna visual/anatômica/histológica (BlueLink cadáver/IO · Dope · Histology/LLU · Dorian — R14/R15/R17), (3) **NEBLIcards autorais** para as lacunas **tipo-a** que as duas primeiras genuinamente não cobrem (probe do termo distintivo = 0). Tudo pousa numa árvore única `NEBLI::<UC>::<Prova>::<Componente>::<Aula>` por **cópia** (AnKing e externos ficam intocados — regra 2026-07-12), **dessuspenso** e **sincronizado** no AnkiWeb. Gates que **bloqueiam o fechamento** (PDF+deck): autoral passa por `lint_neblicard.py` → **`card-mirror` (roda SEMPRE por ora — período de aprendizado do gerador; relaxar quando não render mais)** → `e1_e2_contract.py`; e `gate_deck_aula_completo.py --verify-anki` exige **todo subtópico NUCLEAR COBERTO por card real** (AnKing/externo/autoral) — lacuna nuclear sem card bom trava o fechamento até resolver. Detalhe operacional em `.claude/commands/resumo.md` passo 11 + `FLASHCARDS.md` § Pipeline por aula. O gate absoluto acima (card ancorado na E1) continua valendo para as três fontes.

**1. Passe de aprofundamento da E1 (≈1 injeção mecanística por subtópico).** Depois do rascunho da E1 e da seleção de cards, voltar na E1 e injetar, por subtópico, **1 conteúdo extra mecanístico** — pequeno (1-3 frases), colado a um mecanismo que o subtópico já abriu, que agrega base durável. Dá ~9-12 por resumo. **Proporcionalidade (canônico 2026-07-10):** o "≈1 por subtópico" é piso, não teto uniforme — subtópicos maiores/mais pesados da aula recebem, de forma natural, proporcionalmente mais aprofundamento (e mais cards), deixando o peso do tema reger o espaço. **Regra-mestra — hierarquia das fontes (revista 2026-09-03, pedido de Davi):** (1) **o slide guia o fluxo** — define o recorte e a ordem em que o resumo caminha; (2) **a prova indica o quanto ir a mais** — o acervo de provas da UC dá o teto histórico daquele conteúdo, e a E1 entrega esse teto mais um degrau de mecanismo; (3) **livros e outras fontes indicam assuntos laterais** — bibliografia, AnKing e blueprint sugerem o que vale mencionar de lateral e interessante, e **não** redefinem escopo nem profundidade. Onde a UC não tem acervo de provas, o degrau é calibrado por `banco_slim.json` e depois por `blueprint-step1.md`. Se não há onde encaixar num subtópico, não encaixa — nunca forçar toca de coelho que descasa do slide. Vocabulário Step 1/USMLE/residência continua banido no PDF (o aprofundamento entra como mecanismo/cenário clínico puro). Detalhe operacional em `ROLES.md` § Redator diretriz 17 e `FLASHCARDS.md` § Loop Card→E1.
...
## Profundidade elevada + blocos clínicos maiores + revisor de completude mútua (CANON 2026-07-12, itens 1-2 revistos 2026-09-03)

Pedido de Davi. Valem para **todo resumo daqui pra frente** e entram no pipeline canônico.

1. **Padrão único de profundidade: superior à da prova (revisto 2026-09-03 — pedido de Davi, "padronização do nível de profundidade: superior da prova").** A E1 entrega o **teto histórico que a prova cobra daquele conteúdo, mais um degrau de mecanismo** — o porquê por baixo do fato que o gabarito exige. Esse é o nível de **todo** resumo: não há mais resumo raso nem resumo extra-fundo. Quem apenas empata com a prova ficou raso; quem vai duas camadas além do teto invadiu outra aula. O piso "≈1 injeção mecanística por subtópico" continua, e cada injeção carrega mecanismo, não termo solto. **Qualidade obrigatória:** como é provável que o Davi não tenha visto o extra em aula, o aprofundamento tem que estar correto e bem explicado.

2. **Dial `profundidade:` APOSENTADO (2026-09-03).** Os valores `padrao` e `fundo` deixam de existir — a padronização do item 1 torna o dial redundante, e na prática ele vinha sendo lido como licença de verbosidade (`ERROS.md` F10, corridas `imuno-07` e `gr-02`). No lugar dele, a Seção A do Tema Card declara **duas linhas**: o *teto histórico* daquele conteúdo (o que a prova já cobrou) e o *degrau* que a E1 acrescenta (onde, e qual mecanismo). Tema Card antigo com `profundidade: fundo` gravado continua legível; o campo simplesmente não é mais lido.
...
**Forma — 1 a 2 páginas de prosa contínua na voz NEBLI, contando a história da aula.** (Eram 2 páginas fixas até 2026-09-07; com a tipografia compacta as mesmas ~950 palavras ocupam ~1,5 página. O invariante é a contagem de palavras — os cinco minutos de leitura —, não o número de páginas.) Não é sumário executivo, não é lista de objetivos, não é mini-E1. É narrativa: o que a aula vai fazer, em que ordem, e por quê — na mesma voz de monitor da E1, com as mesmas proibições (sem bullet, sem pergunta retórica, sem mnemônico). **Sem figura** (canônico: as figuras todas ficam na E1). Alvo 900–1100 palavras.
...
- `referencias-externas/uc03/CALIBRACAO.md` + `consultar.py` + `provas-questoes.json` — **calibração por provas antigas, SÓ para aulas de UC03** (canônico 2026-08-27). Acervo de 30 provas da UC03 (2015-2025, 650 subquestões etiquetadas por área) virado régua de profundidade por aula: o que a FMUSP já cobrou daquele slug, e onde a E1 põe o degrau a mais. **Mesmo contrato do `banco_slim.json` e do `blueprint-step1.md`: consultado na redação, NUNCA colado no PDF** (nem enunciado antigo, nem "caiu na P2 de 2024", nem número de prova). Gatilho: a aula é de UC03 → ler antes de fechar o Tema Card (`python referencias-externas/uc03/consultar.py --slug <slug>`); a aula é de outra UC → ignorar este arquivo por inteiro. Cronograma e recorte por aula em `banco/aulas_uc03.yml`. A § Fronteiras é o que impede o resumo de virar caso clínico multiárea: a prova integra o CASO, o resumo cobre a AULA.
...
Removido do que o NEBLI faz, a pedido de Davi (reduzir memory overload — o canal de cards agora é 100% Anki via curadoria AnKing, ver `flashcards/CURADORIA-ANKING.md`). O comando `/flashcards`, os scripts `extrair_clinica.py` e a pasta `flashcards/` continuam no repo mas **fora do pipeline**: não gerar RemNote-cards sem pedido explícito. Helpers Typst `#neblicard`/`#cloze` seguem no-op no template.
...
├── flashcards/           (Etapa 4 — cards RemNote, .md por slug + _INDEX/_REGRAS/_TEMPLATE)
├── backups/
...
2. **Antes da aula** (1–2 páginas, `#pre-aula-page`) — prosa contínua contando a história da aula e plantando em negrito os termos que o professor vai usar. Sem figura. Canônico 2026-08-28; ver § "Antes da aula".
...
- **Largura variável 34–68% com análise caso a caso (canônico 2026-05-28, bandas rebaixadas em 2026-09-07).** Default fixo morreu — vire automatismo. Cada figura recebe largura deliberada conforme **quanto espaço o conteúdo dela merece**: 34–42% para detalhe pontual / ícone esquemático / figura que apoia prosa lateral; 44–54% para figura informativa de peso médio; 56–68% para cadeia multi-passo, mapa orientador de PARTE ou comparativo lado-a-lado que precisa ser legível de longe. Acima de 68% só se a figura **é** o mecanismo (raríssimo). Texto curto + figura pequena: `#figura-lateral`.
  **Por que as bandas caíram (2026-09-07):** figura ocupa área **fixa** na página, texto não. Com o corpo em 8,5pt, as faixas antigas (40–80%, calibradas para 10pt) passaram a comer um terço da página por figura e a deixar rodapés brancos onde antes havia texto. As novas faixas são as antigas multiplicadas por ~0,85, o mesmo fator aplicado à tipografia.
...
2. **Fluidez vence rigidez de regras.** Regras canônicas (cotas de figuras/termo-notas, 15 diretrizes do § Redator em `ROLES.md`, etc.) são **default**, não gate hard da redação. Em conflito entre cumprir checklist e manter prosa fluida, deixa de cumprir e segue o fluxo — anota a quebra no relatório. **Ressalva 2026-09-03:** fluidez nunca é argumento para frase sem função nem para termo parafraseado — o § Registro científico é o piso da voz, não uma cota negociável. Meta-pergunta de fechamento de PARTE: "a leitura flui em voz alta?". Gates hard ficam só nos técnicos (precompile-check, auditar_pdf, paridade Q01–Q30, vocabulário banido).
