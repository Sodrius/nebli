...
- **Teto da Etapa 1 — 15 páginas, cumprido por CONCISÃO (CANON 2026-08-25, pedido de Davi; substitui o teto de 22 de 2026-05-25).** Toda E1 cabe em **até 15 páginas**, contadas da página de abertura da etapa até a anterior ao banner *Resumindo*. **O que encolhe é a quantidade de palavras por ideia, nunca a quantidade de ideias.** Permanecem invariantes: a **cobertura completa** do slide (todo subtópico da aula entra), o **passe de aprofundamento** (§ Aprofundamento, ≈1 injeção mecanística por subtópico, no padrão elevado de 2026-07-12) e a **conclusão integradora** de 4 camadas. Orçamento típico: 10–12 subtópicos de ~350–420 palavras, 9–12 figuras, ~4.000–5.000 palavras de miolo. **É proibido cumprir o teto cortando conteúdo:** estreitar o recorte, suprimir subtópico do slide, remover aprofundamento, amputar a conclusão, comprimir leading/fonte. **A alavanca é escrever mais direto e mais didático** — cortar a moldura conversacional, o preâmbulo antes do mecanismo, o parágrafo que repete o anterior em outro registro, a legenda que reexplica o texto. Se não coube, a leitura correta é que a prosa ainda tem gordura, não que o tema é grande demais: releia e enxugue antes de reportar. Auditável (aviso, não bloqueio) por `auditar_pdf.py` → `check_paginas_e1`. Alavancas em `ERROS.md` F4; detalhe operacional em `ROLES.md` § Redator diretriz 2.
