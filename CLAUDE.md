...
- **Teto da Etapa 1 — 15 páginas (CANON 2026-08-25, pedido de Davi; substitui o teto de 22 de 2026-05-25).** Toda E1 cabe em **até 15 páginas**, contadas da página de abertura da etapa até a anterior ao banner *Resumindo*. Ordem de grandeza que cabe: 8–10 subtópicos, 9–12 figuras, ~3.500–5.500 palavras. O teto é **orçamento declarado na Seção A do Tema Card antes de redigir** — não poda depois de pronto. **Reconciliação com a missão ("ensinar bem > concisão"):** o caminho para ensinar bem em 15 páginas é **recorte mais estreito**, não prosa comprimida. Cortar um subtópico e dizer que ele ficou de fora é legítimo; espremer leading, encolher fonte, virar tópico ou amputar a conclusão integradora não é — isso troca páginas por didática. Se o tema genuinamente não couber, **reportar e perguntar**; estourar o teto é decisão do Davi, não default do redator. Auditável (aviso, não bloqueio) por `auditar_pdf.py` → `check_paginas_e1`. Alavancas em `ERROS.md` F4; detalhe operacional em `ROLES.md` § Redator diretriz 2.
