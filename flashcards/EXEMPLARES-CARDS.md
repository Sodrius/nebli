...
As três ocorrências são `c1`: um único card obriga a associar cada significado ao sufixo correto. `c1/c2/c3` permitiria resolver por oposição depois de ver uma irmã.
...
O Extra não desperdiça espaço com “dermatologia”. Ele usa a raiz conhecida para abrir uma palavra menos óbvia e explicar o segundo elemento.
