...
**Princípio anti-reconhecimento (canônico 2026-07-11, feedback do Davi).** O cloze deve apagar a informação que **exige saber**, não a que se **infere do resto da frase**. Erro clássico: clozar o *rótulo* (o nome da enzima) enquanto a frase já escreve o *mecanismo* inteiro ao lado — aí o Davi acerta por reconhecimento/eliminação. Preferir apagar o **mecanismo, a consequência, o valor ou o discriminador**, deixando o rótulo/cenário como pista. Teste: *"dá pra adivinhar o branco só relendo a frase?"* Se sim, mova o branco.

**Cloze curto e único (correção do overcorrection, 2026-07-11).** Empurrar para a direção difícil **NÃO** é apagar a oração inteira — é **mover o branco para o token-chave certo**. O cloze é **curto**: um token ou frase-curta de alto valor (nos 500 cards do AnKing, o branco tem mediana ~1–3 palavras). Oração inteira clozada perde a **unicidade/atomicidade** e vira um branco vago e difícil de avaliar. A frente carрega o contexto; o branco é **uma** unidade tensa (ex.: apagar `guanina`, `C→T`, `autoclivagem`, `luz visível`, `inativa` — não "parear com guanina fixando uma troca A→G"). Regra prática: se o branco tem >~4 palavras, quase sempre dá para reescrever a frase e apagar só o token que carrega o fato.
