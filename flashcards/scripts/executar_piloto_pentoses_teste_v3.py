#!/usr/bin/env python3
"""Executa o gerador com a última revisão anti-indução do lote."""
...
for old, new in {
    ...
    'The pentose phosphate pathway supplies NADPH and <b>{{c1::ribose-5-phosphate}}</b>.': 'This pathway supplies NADPH and <b>{{c1::ribose-5-phosphate}}</b>.',
