...
As vantagens do método decorrem diretamente da física. Não usa radiação ionizante, o que o libera para uso repetido e para gestante e criança. É o mais barato e o mais portátil dos aparelhos de imagem, e vai ao leito com facilidade. É *dinâmico*: mostra a estrutura se movendo em tempo real, o que permite avaliar peristalse, motilidade diafragmática e contração cardíaca. E oferece o Doppler, que usa a variação de frequência do eco refletido por hemácias em movimento para medir direção e velocidade de fluxo — informação funcional que nem a radiografia nem a tomografia simples fornecem. Como é feito em tempo real e com a mão de quem examina sobre o paciente, também serve para guiar procedimentos, como punções e drenagens.
