...
Duas palavras convivem daqui em diante e não são intercambiáveis por acaso. Toda gama-globulina que exerce função imune é chamada #sigla("Ig", [imunoglobulina — gama-globulina que exerce função de anticorpo; termo que nomeia a molécula sem se comprometer com um alvo específico]), e todo anticorpo é uma imunoglobulina. A recíproca também vale, mas a escolha da palavra carrega ênfase: dizer "anticorpo" pressupõe um alvo em mente — anticorpo *contra alguma coisa* —, enquanto dizer "imunoglobulina" nomeia a classe de molécula sem se comprometer com especificidade nenhuma.
...
As imunoglobulinas variam em três eixos independentes, e confundi-los é a origem de boa parte da dificuldade com esse vocabulário. O critério que separa os três é sempre o mesmo pergunta: variação em relação a quem?
...
Aqui está a inversão que o professor pediu explicitamente para guardar, e ela vale a pena porque três palavras que soam parecidas medem coisas diferentes. A especificidade responde *contra qual* molécula o anticorpo se dirige. A afinidade responde *com que força* um único sítio de ligação segura aquela molécula. A avidez responde *com que força a molécula inteira* segura o alvo, somando todos os sítios que ela consegue engajar ao mesmo tempo.
...
A partir dessas definições, a conclusão da aula é imediata: o tipo de imunoglobulina não afeta a especificidade nem a afinidade. Ambas são propriedades do sítio de ligação, que é construído pelas porções variáveis; a troca de classes mexe na porção constante da cadeia pesada e deixa a variável intacta. O que o isotipo afeta é a avidez, e afeta por geometria pura: a IgM tem dez sítios, a IgG tem dois, logo a IgM segura com força global maior mesmo que cada sítio individual seja igual ou pior.
