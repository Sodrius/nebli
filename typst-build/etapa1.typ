...
Duas propriedades tornam esse órgão diferente dos demais. A primeira é que sua massa varia enormemente — pode multiplicar por cinco no mesmo indivíduo, o que nenhuma outra glândula faz —, e como a secreção de várias adipocinas é proporcional à massa, o *sinal* também varia junto. E a escala importa: num adulto magro o tecido adiposo responde por algo em torno de 15% a 20% do peso corporal, proporção que pode passar de 40% na obesidade grave — nenhuma outra fonte de hormônio do corpo cresce assim. A segunda propriedade é que ele não é um tecido único. A gordura branca estoca triacilglicerol numa gota única que empurra o núcleo para a borda, e é ela que secreta leptina; a gordura parda é recheada de mitocôndrias e existe para uma finalidade oposta, gerar calor, o que a torna o efetor da #termo-nota[termogênese][produção deliberada de calor pelo metabolismo, sem trabalho mecânico associado, usada para manter a temperatura e queimar excedente].
