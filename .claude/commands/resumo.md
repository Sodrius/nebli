...
6. **Redigir E1 (rascunho)** seguindo as regras do `redator-e1.md`. Gravar via heredoc `etapa1.typ`, `resumindo.typ` e **`pre-aula.typ`** (2ª parte do Resumindo — texto corrido de até 2 páginas, voz NEBLI, para quem NÃO leu a E1 e vai assistir a aula; canônico 2026-08-27; ver `CLAUDE.md` § Resumindo Parte 2 e `ROLES.md` § Redator diretriz 5.bis). Aplicar filtro de utilidade pedagógica de figuras (regra 15). Reportar paridade de densidade entre PARTES (regra 14).
