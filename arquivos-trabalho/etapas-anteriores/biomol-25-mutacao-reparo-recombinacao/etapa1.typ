...
O ponto de partida é sempre o mesmo obstáculo prático: a região que interessa está presente em quantidade ínfima e misturada a todo o resto do genoma. Determinar a sequência de um gene, produzir a proteína que ele codifica, fazer um teste de paternidade, diagnosticar uma doença genética ou identificar um vírus a partir do seu material genético — todas essas tarefas exigem *muitas cópias puras* daquele trecho. Daí a questão central que organiza toda a aula passa a ser uma só: como sair de uma cópia diluída para bilhões de cópias isoladas? Há dois caminhos, e a tecnologia usa os dois conforme a conveniência: copiar o trecho quimicamente num tubo (PCR) ou inseri-lo numa bactéria e deixar a bactéria se multiplicar carregando o trecho dentro dela (clonagem).
...
O modo de cortar divide as enzimas em dois grupos de enorme consequência prática. Algumas, como a _Hae_III ou a _Eco_RV, fazem um *corte reto*: cortam as duas fitas na mesma posição, deixando extremidades de fita dupla "cegas" (blunt). Outras, como a _Eco_RI, fazem um *corte desalinhado*: cortam as duas fitas em posições deslocadas, deixando em cada fragmento uma pequena saliência de fita simples. Essas saliências são as #termo-nota[pontas coesivas][extremidades de fita simples complementares geradas por corte desalinhado, que se reparam por pareamento com qualquer ponta cortada pela mesma enzima — também ditas "pegajosas"] — e elas são o segredo de toda a montagem, como veremos em 3.3.

A nomenclatura segue uma regra fixa que vale memorizar pela lógica: a primeira letra (maiúscula) vem do gênero da bactéria, as duas seguintes da espécie, e um algarismo romano indica a ordem de descoberta naquela linhagem. _Eco_RI vem de _Escherichia coli_, primeira enzima de restrição daquela linhagem; _Hae_III de _Haemophilus aegyptius_, e assim por diante. O nome carrega a origem biológica da tesoura.
...
#figura-nebli("/figuras/biomol-26-dna-recombinante-pcr/slide-47.jpeg",
  largura: 50%,
  legenda: [O plasmídeo pBR322: a *origem de replicação* (Ori) garante que ele seja copiado; os genes de *resistência a ampicilina e a tetraciclina* permitem selecionar as bactérias transformadas; os sítios únicos de _Eco_RI, _Sal_I e _Pst_I oferecem pontos exatos para abrir o círculo e inserir o fragmento.])
