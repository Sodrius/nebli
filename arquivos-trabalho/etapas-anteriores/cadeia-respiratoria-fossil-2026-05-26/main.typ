...
#capa(
  ...
  (
    ...
    ("Nota de uso", "Leia a PARTE I devagar — entender a *lógica termodinâmica* (por que fracionar a queima) é o que faz o resto fazer sentido. Se travar na PARTE III com inibidores e desacopladores, volte para a figura do gradiente e da força próton-motriz; tudo decorre dela. A tabela mecanística da última página é referência para consulta rápida."),
    ("Onde estudar", "Lehninger 7ª ed., Cap. 19 (Fosforilação oxidativa) pp. 731–786 + Voet Cap. 22"),
  ),
)
...
#sumario((
  ...
  ("Tabela mecanística (referência)", (
    (none, (
      "1 página com complexos, inibidores, saldos",
    )),
  )),
