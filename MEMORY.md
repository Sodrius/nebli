...
manifesto e o `score` da validação é o mínimo contratual, marcado com
`score_basis="plan_contract_minimum"`; a resolução real acontece no Companion e
`anking_required=true` bloqueia o lote se a nota não existir.
