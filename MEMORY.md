...
- **Resumo `correlacao-radio-pato-2` gerado** (Correlação radiopatológica do fígado, aula RD/PT de 2023, dial `profundidade: fundo`). 39 páginas, E1 com 19. Etapas 1-3 fechadas; deck-aula do passo 11 **não** rodou — sessão remota não alcança o AnkiConnect local.
