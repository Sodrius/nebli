...
- **Patologia entra como disciplina nova (2026-08-21):** primeiro resumo de Patologia geral — `patologia-01-lesao-morte-celular` ("Lesão e morte celular", Prof. Dr. Luiz Fernando Ferraz da Silva, Depto. de Patologia FMUSP; vídeo-aula Parte 1, 47 slides, figuras do Robbins 9ª ed.). **Não consta dos cronogramas de Ciclo da Vida I (UC-16) nem de Digestório (UC-8)** — se for de uma terceira UC/componente, confirmar com Davi para encaixar aula→prova→componente na árvore do Drive/Anki. Sem banco de questões (calibração veio do slide + Robbins). E1 22 páginas, 18 figuras, 30 objetivas (20 MC + 10 C/E), 5 discursivas.
