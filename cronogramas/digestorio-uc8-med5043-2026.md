# Cronograma — Digestório (UC-8 · Med5043 · Anatomia do Sistema Digestório) · 2026 · 2º semestre
...
## Provas
- **PROVA 1** (Anato/Fisio/Biocel) — Turma A **08/10** · Turma B **05/10** (anf. 202 / lab 007).
- **PROVA 2** (Anato/Fisio/Biocel) — Turma A **26/11** · Turma B **30/11** (anf. 202 / lab 007).
- Recuperação: 2ª quinzena de fevereiro do ano seguinte.

## Aulas por componente (aula → data TA / TB → componente → prova)

### Bloco Prova 1
| Aula (tema) | Turma A | Turma B | Componente | Prova |
|---|---|---|---|---|
| Introdução geral da disciplina | 06/08 | 03/08 | todas | P1 |
| Esôfago / Estômago / Intestino delgado (teórica + prática) | 06/08 | 03/08 | Anatomia | P1 |
...
| *(Semana da Pátria FM: 21/09 – 24/09)* | — | — | — | — |
...
| Cavidade abdominal — Peritônio (teórica + prática) | 05/11 | 16/11 | Anatomia | P2 |
| Inervação do sistema digestório (+ Sistema Linfático) (teórica + prática) | 12/11 | 23/11 | Anatomia | P2 |
| Estudo livre | 19/11 | 19/11 | Anatomia | P2 |
